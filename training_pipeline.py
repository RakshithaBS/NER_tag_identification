...
train_model = PythonOperator(task_id='train_model',python_callable=utils.trainModel,dag=ML_data_cleaning_dag,op_kwargs={'tracking_uri':constants.TRACKING_URI,'artifact_uri':constants.ARTIFACT_URI,'db_name':constants.DB_NAME,'experiment_name':constants.EXPERIMENT_NAME,'training_file_path':constants.DATA_PATH,'config_file_path':constants.TRAINING_CONFIG_FILE_PATH})
